...
scenario_detail <- data.frame(Detail = c(
  ...
  "S1 : RB 75-gal for HLawn",                "S2 : RB 75-gal for HSplash",                       "S3 : RB 75-gal for HStreet",     
  "S4 : RB 75-gal for HDC",                  "S5 : RB 75-gal for HDC + HStreet",                 "S6 : RB 75-gal for all",
  
  "S7 : RB 150-gal for HLawn",               "S8 : RB 150-gal for HSplash",                      "S9 : RB 150-gal for HStreet",     
  "S10: RB 150-gal for HDC",                 "S11: RB 150-gal for HDC + HStreet",                "S12: RB 150-gal for all",
  
  "S13: 2 RB 150-gal for HLawn",             "S14: 2 RB 150-gal for HSplash",                    "S15: 2 RB 150-gal for HStreet",     
  "S16: 2 RB 150-gal for HDC",               "S17: 2 RB 150-gal for HDC + HStreet",              "S18: 2 RB 150-gal for all",
  
  "S19: RB 1000-gal for HLawn",              "S20: RB 1000-gal for HSplash",                     "S21: RB 1000-gal for HStreet",     
  "S22: RB 1000-gal for HDC",                "S23: RB 1000-gal for HDC + HStreet",               "S24: RB 1000-gal for all",
  
  "S25: Cistern 5000-gall for Rcom", 
  
  "S26: Cistern + RB 75-gal for HLawn",      "S27: Cistern + RB 75-gal for HSplash",             "S28: Cistern + RB 75-gal for HStreet",     
  "S29: Cistern + RB 75-gal for HDC",        "S30: Cistern + RB 75-gal for HDC + HStreet",       "S31: Cistern + RB 75-gal for all",
  
  "S32: Cistern + RB 150-gal for HLawn",     "S33: Cistern + RB 150-gal for HSplash",            "S34: Cistern + RB 150-gal for HStreet",     
  "S35: Cistern + RB 150-gal for HDC",       "S36: Cistern + RB 150-gal for HDC + HStreet",      "S37: Cistern + RB 150-gal for all",
  
  "S38: Cistern + 2 RB 150-gal for HLawn",   "S39: Cistern + 2 RB 150-gal for HSplash",          "S40: Cistern + 2 RB 150-gal for HStreet",     
  "S41: Cistern + 2 RB 150-gal for HDC",     "S42: Cistern + 2 RB 150-gal for HDC + HStreet",    "S43: Cistern + 2 RB 150-gal for all",
  
  "S44: Cistern + RB 1000-gal for HLawn",    "S45: Cistern + RB 1000-gal for HSplash",           "S46: Cistern + RB 1000-gal for HStreet",     
  "S47: Cistern + RB 1000-gal for HDC",      "S48: Cistern + RB 1000-gal for HDC + HStreet",     "S49: Cistern + RB 1000-gal for all",
  
  "S50: Downspout Disconnection (DSD)", 
  
  "S51: DSD + RB 75-gal for HLawn",                "S52: DSD + RB 75-gal for HSplash",                       "S53: DSD + RB 75-gal for HStreet",     
  "S54: DSD + RB 75-gal for HDC",                  "S55: DSD + RB 75-gal for HDC + HStreet",                 "S56: DSD + RB 75-gal for all",
  
  "S57: DSD + RB 150-gal for HLawn",               "S58: DSD + RB 150-gal for HSplash",                      "S59: DSD + RB 150-gal for HStreet",     
  "S60: DSD + RB 150-gal for HDC",                 "S61: DSD + RB 150-gal for HDC + HStreet",                "S62: DSD + RB 150-gal for all",
  
  "S63: DSD + 2 RB 150-gal for HLawn",             "S64: DSD + 2 RB 150-gal for HSplash",                    "S65: DSD + 2 RB 150-gal for HStreet",     
  "S66: DSD + 2 RB 150-gal for HDC",               "S67: DSD + 2 RB 150-gal for HDC + HStreet",              "S68: DSD + 2 RB 150-gal for all",
  
  "S69: DSD + RB 1000-gal for HLawn",              "S70: DSD + RB 1000-gal for HSplash",                     "S71: DSD + RB 1000-gal for HStreet",     
  "S72: DSD + RB 1000-gal for HDC",                "S73: DSD + RB 1000-gal for HDC + HStreet",               "S74: DSD + RB 1000-gal for all",
  
  "S75: DSD + Cistern", 
  
  "S76: DSD + Cistern + RB 75-gal for HLawn",      "S77: DSD + Cistern + RB 75-gal for HSplash",             "S78: DSD + Cistern + RB 75-gal for HStreet",     
  "S79: DSD + Cistern + RB 75-gal for HDC",        "S80: DSD + Cistern + RB 75-gal for HDC + HStreet",       "S81: DSD + Cistern + RB 75-gal for all",
  
  "S82: DSD + Cistern + RB 150-gal for HLawn",     "S83: DSD + Cistern + RB 150-gal for HSplash",            "S84: DSD + Cistern + RB 150-gal for HStreet",     
  "S85: DSD + Cistern + RB 150-gal for HDC",       "S86: DSD + Cistern + RB 150-gal for HDC + HStreet",      "S87: DSD + Cistern + RB 150-gal for all",
  
  "S88: DSD + Cistern + 2 RB 150-gal for HLawn",   "S89: DSD + Cistern + 2 RB 150-gal for HSplash",          "S90: DSD + Cistern + 2 RB 150-gal for HStreet",     
  "S91: DSD + Cistern + 2 RB 150-gal for HDC",     "S92: DSD + Cistern + 2 RB 150-gal for HDC + HStreet",    "S93: DSD + Cistern + 2 RB 150-gal for all",
  
  "S94: DSD + Cistern + RB 1000-gal for HLawn",    "S95: DSD + Cistern + RB 1000-gal for HSplash",           "S96: DSD + Cistern + RB 1000-gal for HStreet",     
  "S97: DSD + Cistern + RB 1000-gal for HDC",      "S98: DSD + Cistern + RB 1000-gal for HDC + HStreet",     "S99: DSD + Cistern + RB 1000-gal for all"
...
write_inp (bs_file_for_write_new, "S0.inp")
  ...
  # ----- 3.3: Scenarios 1 - 24: Rain Barrel ----- 
...
bs_lid_RB [[1]] <- filter(bs_lid_1RB_75, grepl("HLawn", Subcatchment)); 
bs_lid_RB [[2]] <- filter(bs_lid_1RB_75, grepl("HSplash", Subcatchment)); 
bs_lid_RB [[3]] <- filter(bs_lid_1RB_75, grepl("HStreet", Subcatchment) | grepl("Hstreet", Subcatchment)); 
bs_lid_RB [[4]] <- filter(bs_lid_1RB_75, grepl("HDC", Subcatchment)); 
bs_lid_RB [[5]] <- filter(bs_lid_1RB_75, grepl("HDC", Subcatchment) | grepl("HStreet", Subcatchment) | grepl("Hstreet", Subcatchment));
bs_lid_RB [[6]] <- bs_lid_1RB_75; 

# Scenario 7 - 12  (RB 150 gallon) ..........
bs_lid_RB [[7]]  <- filter(bs_lid_1RB_150, grepl("HLawn", Subcatchment)); 
bs_lid_RB [[8]]  <- filter(bs_lid_1RB_150, grepl("HSplash", Subcatchment)); 
bs_lid_RB [[9]]  <- filter(bs_lid_1RB_150, grepl("HStreet", Subcatchment) | grepl("Hstreet", Subcatchment)); 
bs_lid_RB [[10]] <- filter(bs_lid_1RB_150, grepl("HDC", Subcatchment)); 
bs_lid_RB [[11]] <- filter(bs_lid_1RB_150, grepl("HDC", Subcatchment) | grepl("HStreet", Subcatchment) | grepl("Hstreet", Subcatchment));
bs_lid_RB [[12]] <- bs_lid_1RB_150; 

# Scenario 13 - 18  (2 RB 150 gallon) ..........
bs_lid_RB [[13]] <- filter(bs_lid_2RB_150, grepl("HLawn", Subcatchment)); 
bs_lid_RB [[14]] <- filter(bs_lid_2RB_150, grepl("HSplash", Subcatchment)); 
bs_lid_RB [[15]] <- filter(bs_lid_2RB_150, grepl("HStreet", Subcatchment) | grepl("Hstreet", Subcatchment)); 
bs_lid_RB [[16]] <- filter(bs_lid_2RB_150, grepl("HDC", Subcatchment)); 
bs_lid_RB [[17]] <- filter(bs_lid_2RB_150, grepl("HDC", Subcatchment) | grepl("HStreet", Subcatchment) | grepl("Hstreet", Subcatchment));
bs_lid_RB [[18]] <- bs_lid_2RB_150; 

# Scenario 19 - 24  (RB 1000 gallon) ..........
bs_lid_RB [[19]] <- filter(bs_lid_1RB_1000, grepl("HLawn", Subcatchment)); 
bs_lid_RB [[20]] <- filter(bs_lid_1RB_1000, grepl("HSplash", Subcatchment)); 
bs_lid_RB [[21]] <- filter(bs_lid_1RB_1000, grepl("HStreet", Subcatchment) | grepl("Hstreet", Subcatchment)); 
bs_lid_RB [[22]] <- filter(bs_lid_1RB_1000, grepl("HDC", Subcatchment)); 
bs_lid_RB [[23]] <- filter(bs_lid_1RB_1000, grepl("HDC", Subcatchment) | grepl("HStreet", Subcatchment) | grepl("Hstreet", Subcatchment));
bs_lid_RB [[24]] <- bs_lid_1RB_1000; 
...
bs_lid_cistern_new <- bs_lid_usage %>% 
  full_join(bs_lid_1cistern_5000, by = c("Subcatchment", "LID Process", "Area", "Number",  "Area", "Width", "InitSat", "FromImp", "ToPerv"))
      ...
      # ----- 3.4.2: Building Cistern Scenarios -----
...
for ( i in 1: bs_number) {
  ...
  write_inp (bs_file_for_write_new, file_inp_scenario_pre[25+i])
}

  # ----- 3.6: Scenario 50: Downspout Disconnection (DSD) -----
...
write_inp (bs_file_for_write_new, file_inp_scenario_pre[50])

  # ----- 3.7: Scenario 51-64: DSD + RB -----
...
for ( i in 1: bs_number) {
  bs_file_for_write_new $ lid_usage <- bs_lid_RB_new[[i]]
  write_inp (bs_file_for_write_new, file_inp_scenario_pre[50+i])
}

  # ----- 3.8: Scenario 75: DSD + Cistern -----
...
write_inp (bs_file_for_write_new, file_inp_scenario_pre[75])

  # ----- 3.9: Scenario 76 - 99: DSD + Cistern + RB -----
...
for (i in 1:bs_number) {
  bs_file_for_write_new $ lid_usage <- bs_lid_RB_cistern_new[[i]]
  write_inp (bs_file_for_write_new, file_inp_scenario_pre[75+i])
}
...
fun_water_ballance <- function(design_scenario) {
  ...
  # ----- 4.3: LID Number and Cost Function  -----
...
# ----- 5: Run the Functions -----
  ...
  # ----- 5.1: Run Water Ballance Function -----
...
s_flow_routing_continuity_2 <- s_flow_routing_continuity %>% mutate(Summation = Dry_weather_inflow_mg+Wet_weather_inflow_mg+External_inflow_mg+Groundwater_inflow_mg-Flooding_loss_mg - External_outflow_mg)
  ...
  # ----- 5.2: Run LID Number and Cost Function  -----
